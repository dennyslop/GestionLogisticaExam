...
namespace OrdenesApi
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                config.CreateMap<EntregaMaritimo, OrdenesMaritimasDTO>();
                config.CreateMap<OrdenesMaritimasDTO, EntregaMaritimo>();
                config.CreateMap<EntregaTerrestre, OrdenesTerrestresDTO>();
                config.CreateMap<OrdenesTerrestresDTO, EntregaTerrestre>();
            });
